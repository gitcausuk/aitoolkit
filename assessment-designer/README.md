# Oxford Assessment Designer

A static, privacy-first web app that helps Oxford faculty redesign assessments across disciplines. It is designed to sit beside the Oxford AI Toolkit and deploy on GitHub Pages.
...
- Recommends a Toolkit permission level: Not Permitted, Limited, Open or Integral.
- Applies VIVA: Valid, Inclusive, Visible and Accountable.
- Uses all 40 Oxford assessment formats as format-specific reference data.
