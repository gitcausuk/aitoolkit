(function () {
  ...
  const SOURCE_CHECK_DATE = '24 July 2026';
  ...
  function permissionReason(data, level) {
    ...
    if (level === 'integral') return 'The entered learning outcomes or capabilities indicate that using or evaluating AI is itself part of the intended learning.';
  ...
  function renderReport(report) {
    ...
    const formatStrategy = data.formatItem ? '<div class="callout"><span class="callout-title">Format-specific strategy</span><p>' + escapeHTML(data.formatItem.strategy) + '</p></div>' : '';
  ...
  function reportWordHTML(report) {
    ...
    return '<!DOCTYPE html><html><head><meta charset="utf-8"><title>' + escapeHTML(data.assessmentTitle || 'Assessment redesign') + '</title>' +
      ...
      '<h2>Sources and status</h2><ul><li>Oxford University AI use in summative assessment policy</li><li>Oxford Centre for Teaching and Learning AI and academic practice resources</li><li>Oxford AI Toolkit assessment resources</li></ul><p>Public sources checked ' + SOURCE_CHECK_DATE + '. Check the live official source before relying on a present-tense policy claim.</p>' +
      '</body></html>';
  }
