(function () {
  ...
  function renderReport(report) {
    ...
    const formatStrategy = data.formatItem ? '<div class="callout"><strong>Oxford format-specific strategy</strong><p>' + escapeHTML(data.formatItem.strategy) + '</p></div>' : '';
  ...
  function saveInputs() {
    const data = getData();
    const exportData = { exportedAt: new Date().toISOString(), app: 'Oxford Assessment Designer 1.0.0', inputs: data };
